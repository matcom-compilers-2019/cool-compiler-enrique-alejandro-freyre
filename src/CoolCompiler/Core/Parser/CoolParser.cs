...
public partial class CoolParser : Parser {
	...
	public const int
		RULE_program = 0, RULE_classdef = 1, RULE_feature = 2, RULE_method = 3, 
		RULE_property = 4, RULE_formal = 5, RULE_expr = 6;
	public static readonly string[] ruleNames = {
		"program", "classdef", "feature", "method", "property", "formal", "expr"
	};
	...
	public partial class BoolNotContext : ExprContext {
		public ITerminalNode NOT() { return GetToken(CoolParser.NOT, 0); }
		public ExprContext expr() {
			return GetRuleContext<ExprContext>(0);
		}
		public BoolNotContext(ExprContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ICoolVisitor<TResult> typedVisitor = visitor as ICoolVisitor<TResult>;
	...
	public partial class ComparissonContext : ExprContext {
		public IToken op;
		public ExprContext[] expr() {
			return GetRuleContexts<ExprContext>();
		}
		...
		public ComparissonContext(ExprContext context) { CopyFrom(context); }
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			ICoolVisitor<TResult> typedVisitor = visitor as ICoolVisitor<TResult>;
	...
	private ExprContext expr(int _p) {
		...
		try {
			...
			case 1:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__1) | (1L << T__3) | (1L << T__9) | (1L << FALSE) | (1L << IF) | (1L << ISVOID) | (1L << LET) | (1L << WHILE) | (1L << CASE) | (1L << NEW) | (1L << NOT) | (1L << TRUE) | (1L << INT) | (1L << ID) | (1L << STRING))) != 0)) {
					{
					{
					State = 78; expr(0);
					State = 83;
